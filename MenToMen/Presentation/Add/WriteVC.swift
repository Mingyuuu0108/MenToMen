...
class WriteVC: UIViewController, ConstraintRelatableTarget {
    ...
    private let selectTagiOS = UIButton().then {
        $0.setImage(UIImage(systemName: "iOS"), for: .normal)
    }
    
    private let selectTagAndroid = UIButton().then {
        $0.setImage(UIImage(systemName: "Android"), for: .normal)
    }
    
    private let selectTagServer = UIButton().then {
        $0.setImage(UIImage(systemName: "Server"), for: .normal)
    }
    
    private let selectTagWeb = UIButton().then {
        $0.setImage(UIImage(systemName: "Web"), for: .normal)
    }
    
    private let selectTagDesign = UIButton().then {
        $0.setImage(UIImage(systemName: "Design"), for: .normal)
    }
